...
curl -fsSL https://repositories.scylladb.com/scylla/keys/scylla-keyring.gpg | gpg --dearmor --yes -o /etc/apt/keyrings/scylla.gpg || true
echo "deb [signed-by=/etc/apt/keyrings/scylla.gpg] http://repositories.scylladb.com/scylla/repo/debian/scylladb-5.4 trixie main" > /etc/apt/sources.list.d/scylla.list
